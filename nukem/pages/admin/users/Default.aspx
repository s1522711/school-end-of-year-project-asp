<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="pages_admin_users_Default" %>
                        ...
                        <ul class="navbar-nav mr-auto" runat="server" id="adminDropdown">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu mt-0" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item active" href="./">User List</a>
